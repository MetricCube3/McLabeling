...
from models import Project, User, AnnotationTask, ReviewTask, VideoPool, ExtractionInfo
from dependencies import require_admin, is_admin, get_user_roles
import logging
...
def get_project_task_stats(
    ...
    try:
        ...
        result = {
            ...
            "total_stats": {
                "total_tasks": len(annotation_tasks),
        ...
        logger.info(f"Project stats for '{project}': {len(annotation_tasks)} tasks, {total_images} images, {total_annotated} annotated")
        return result
